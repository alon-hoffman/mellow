  ...
  <section class="board-details">
    ...
    <div class="board-header">
      <div class="board-header-left">
        ...
        <button class="star-board-details-btn"><img class="star-img-board" src="../assets/icons/star-regular-2.png" alt=""></button>
      </div>
      <div class="board-header-right">
        ...
        <button class="more-btn"><svg width="24" height="24" role="presentation" focusable="false"
